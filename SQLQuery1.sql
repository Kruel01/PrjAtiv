CREATE TABLE [Cliente] (
	...
	ClienteLogin nvarchar(255) NOT NULL,
...
Alter table Cliente add constraint CKH_Status_Conta_Cliente check (statusConta = 'Ativa' or StatusConta = 'Encerrada' or StatusConta = 'Bloqueada');

Alter table cliente add constraint CHK_TipoConta_Cliente check (TipoConta = 'Correntista' or TipoConta = 'Especial');
